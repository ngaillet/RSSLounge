 ...
 */
class plugins_images_deviantart extends plugins_rss_multimedia {
     ...
     * @var string
     */
    public $icon = 'plugins/images/deviantart.png';
     ...
     * @var string
     */
    public $description = 'This feed fetches the gallery of a deviantart user';
    ...
    public function opml($url) {
        return 'http://backend.deviantart.com/rss.xml?q=sort%3Atime%20by%3A'.urlencode($url).'&type=deviation';
    }
